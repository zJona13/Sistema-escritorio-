Public Class FrmVenta
    ...
    Private Sub BtnBuscarArticulosDetalle_Click(sender As Object, e As EventArgs)
        Buscar_A()
    End Sub
    ...
    Private Sub BtnBuscarArticulosDetalle_Click_1(sender As Object, e As EventArgs) Handles BtnBuscarArticulosDetalle.Click
        Try
            Dim Neg As New Negocio.NArticulo
            Dim Valor As String
            Valor = TxtBuscarArticulos.Text
